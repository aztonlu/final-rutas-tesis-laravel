...
class TourControllerWeb extends Controller
{
    ...
    public function tourshow($id)
    {
        ...
        return view('website.fr.tours.decouverte.tresors-du-sud-perou')->with('galleries', $gallery)->with('tours',$tour)->with('organizations',$organization)->with('etapes',$etapes)->with('etapesforMap',$tag)->with('images',$imageTour);
    }
